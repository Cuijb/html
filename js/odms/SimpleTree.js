 ...
 * Update: 崔佳宾
 * Date: 2016.05.20
 * Discription: 将li和a的点击事件分开，li负责展开、收起；a响应用户自定义事件
*/
	...
	$.fn.extend({
		SimpleTree:function(options){
			...
			/* this.find("a").click(function(){
				 ...
				 * 触发用户自定义的单击事件，将当前超链接做为参数传递过去
				 
				option.click(option.params);	 触发单击 
				return false; 
			}); */
			...
			this.find("li").click(function(){
				/*
				 * 当单击菜单项 <li>
				 * 1.修改当前菜单项所属的子菜单的显示状态（如果等于 true 将其设置为 false，否则将其设置为 true）
				 * 2.重新初始化菜单
				 */
				/* 
